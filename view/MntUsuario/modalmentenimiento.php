...
<div id="modalmentenimiento"class="modal fade bd-example-modal-lg"
        tabindex="-1"
        role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="mdtitulo"></h4>
            </div>
            <form method="post" id="usuario_form">
                ...
                <input type="hidden" id="usu_id" name="usu_id">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="uso_ape">Apellido</label>
                        <input type="text" class="form-control" id="uso_ape" name="uso_ape" placeholder="Ingrese Apellido" required>    
                    </div>
                    <div class="form-group">
